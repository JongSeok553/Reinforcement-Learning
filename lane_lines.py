...
def filter_colors(image):
    ...
    upper_white = np.array([180, 182, 180])
    white_mask = cv2.inRange(image1, lower_white, upper_white)
    white_image = cv2.bitwise_and(image1, image1, mask=white_mask)

    # Filter yellow pixels
    # hsv = cv2.cvtColor(image, cv2.COLOR_BGR2HSV)
    lower_yellow = np.array([100, 100, 50]) # 125 125 60
    upper_yellow = np.array([180, 180, 120]) # 180 180 110
    yellow_mask = cv2.inRange(image2, lower_yellow, upper_yellow)
    yellow_image = cv2.bitwise_and(image2, image2, mask=yellow_mask)
